...
// Package forkid implements EIP-2124 (https://eips.gamefin.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Gamefin fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Gamefin fork ID from an existing chain instance.
