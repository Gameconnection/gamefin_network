...
// Package types contains data types related to Gamefin consensus.
package types
...
// Header represents a block header in the Gamefin blockchain.
type Header struct {
...
// Block represents an entire block in the Gamefin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Gamefin RLP block format.
