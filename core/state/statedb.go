...
// Package state provides a caching layer atop the Gamefin state trie.
package state
...
// StateDB structs within the gamefin protocol are used to store anything
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/gameconnection/gamefin_network/pull/16485#issuecomment-380438527),
