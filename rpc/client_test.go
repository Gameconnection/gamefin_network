...
// This test reproduces https://github.com/gameconnection/gamefin_network/issues/17837 where the
...
// It is the reproducer for https://github.com/gameconnection/gamefin_network/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-gamefin-test-ipc-%d-%d", os.Getpid(), rand.Int63())
