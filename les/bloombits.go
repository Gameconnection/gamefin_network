...
import (
	...
	"github.com/gameconnection/gamefin_network/common/bitutil"
	"github.com/gameconnection/gamefin_network/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Gamefin
...
func (eth *LightGamefin) startBloomHandlers(sectionSize uint64) {
