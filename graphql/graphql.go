...
// Package graphql provides a GraphQL interface to Gamefin node data.
package graphql
...
// Account represents an Gamefin account at a particular block.
type Account struct {
...
// Transaction represents an Gamefin transaction.
...
// Block represents an Gamefin block.
...
type CallData struct {
	From                 *common.Address // The Gamefin address the call is from.
	To                   *common.Address // The Gamefin address the call is to.
