...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Gamefin address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Gamefin account at a particular block.
    type Account {
    ...
    # Transaction is an Gamefin transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Gamefin account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Gamefin account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Gamefin block by number or by hash. If neither is
