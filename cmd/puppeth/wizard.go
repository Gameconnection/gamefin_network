...
type wizard struct {
	...
	services map[string][]string   // Gamefin services known to be running on servers
...
// converts it to an Gamefin address. If an empty line is entered, the default
// value is returned.
