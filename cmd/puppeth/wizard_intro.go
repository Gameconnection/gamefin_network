...
// setting up a new or managing an existing Gamefin private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Gamefin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Gamefin network down to  |")
	...
	log.Info("Administering Gamefin network", "name", w.network)
