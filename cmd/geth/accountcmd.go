...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Gamefin presale wallets",
		ArgsUsage: "",
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Gamefin presale wallet",
				ArgsUsage: "<keyFile>",
...
between gamefin nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another gamefin instance,
