...
import (
	...
	"github.com/gameconnection/gamefin_network/internal/jsre"
	"github.com/gameconnection/gamefin_network/internal/jsre/deps"
	"github.com/gameconnection/gamefin_network/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Gamefin requests through
