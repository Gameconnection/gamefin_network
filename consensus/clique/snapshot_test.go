...
// mapped from textual names used in the tests below to actual Gamefin private
...
// address retrieves the Gamefin address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Gamefin address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/gameconnection/gamefin_network/issues/17593). Whilst this
