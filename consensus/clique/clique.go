...
// ecrecover extracts the Gamefin account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Gamefin address
...
// Gamefin testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Gamefin address of the signing key
...
// Author implements consensus.Engine, returning the Gamefin address recovered
