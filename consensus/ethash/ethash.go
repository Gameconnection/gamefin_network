...
// all blocks' seal as valid, though they still have to conform to the Gamefin
// consensus rules.
...
// still have to conform to the Gamefin consensus rules.
...
// they still have to conform to the Gamefin consensus rules.
