...
var (
	...
	// Specification EIP-4345: https://eips.gamefin.org/EIPS/eip-4345
	calcDifficultyEip4345 = makeDifficultyCalculator(big.NewInt(10_700_000))

	// calcDifficultyEip3554 is the difficulty adjustment algorithm as specified by EIP 3554.
	// It offsets the bomb a total of 9.7M blocks.
	// Specification EIP-3554: https://eips.gamefin.org/EIPS/eip-3554
	calcDifficultyEip3554 = makeDifficultyCalculator(big.NewInt(9700000))

	// calcDifficultyEip2384 is the difficulty adjustment algorithm as specified by EIP 2384.
	// It offsets the bomb 4M blocks from Constantinople, so in total 9M blocks.
	// Specification EIP-2384: https://eips.gamefin.org/EIPS/eip-2384
	...
	// bomb offset 5M.
	// Specification EIP-1234: https://eips.gamefin.org/EIPS/eip-1234
	calcDifficultyConstantinople = makeDifficultyCalculator(big.NewInt(5000000))

	// calcDifficultyByzantium is the difficulty adjustment algorithm. It returns
	// the difficulty that a new block should have when created at time given the
	// parent block's time and difficulty. The calculation uses the Byzantium rules.
	// Specification EIP-649: https://eips.gamefin.org/EIPS/eip-649
...
// rules of the stock Gamefin ethash engine.
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/gamefin/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
		...
		// Specification: https://eips.gamefin.org/EIPS/eip-1234
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/gamefin/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
