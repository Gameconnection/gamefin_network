...
// Package ethclient provides a client for the Gamefin RPC API.
package ethclient
...
// Client defines typed wrappers for the Gamefin RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*gamefin.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (gamefin.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q gamefin.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q gamefin.FilterQuery, ch chan<- types.Log) (gamefin.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q gamefin.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg gamefin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg gamefin.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg gamefin.CallMsg) (uint64, error) {
...
func toCallArg(msg gamefin.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *gamefin.SyncProgress {
	if p == nil {
		return nil
	}
	return &gamefin.SyncProgress{
