...
import "github.com/gameconnection/gamefin_network/common"

// MainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Gamefin network.
var MainnetBootnodes = []string{
	// Gamefin Foundation Go Bootnodes
...
// genesis hash and protocol. See https://github.com/gamefin/discv4-dns-lists for more
// information.
