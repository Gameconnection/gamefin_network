...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain gamefin.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to gamefin-type signature.
		signature[64] -= 27 // Transform V from Gamefin-legacy to 0/1
	}
