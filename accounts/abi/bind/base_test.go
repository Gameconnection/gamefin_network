...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call gamefin.CallMsg) (gas uint64, err error) {
	return 0, nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call gamefin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call gamefin.CallMsg) ([]byte, error) {
