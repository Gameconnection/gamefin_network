...
// Package bind generates Gamefin contract Go bindings.
//
// Detailed usage document and tutorial available on the go-gamefin Wiki page:
// https://github.com/gameconnection/gamefin_network/wiki/Native-DApps:-Go-bindings-to-Gamefin-contracts
package bind
