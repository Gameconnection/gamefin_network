...
// Syncing provides information when this nodes starts synchronising with the Gamefin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  gamefin.SyncProgress `json:"status"`
}
