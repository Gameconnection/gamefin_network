...
// information related to the Gamefin protocol such als blocks, transactions and logs.
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(gamefin.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as gamefin.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria gamefin.FilterQuery
...
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	...
	logsSub, err := api.events.SubscribeLogs(gamefin.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
