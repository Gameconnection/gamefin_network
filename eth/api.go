...
// PublicGamefinAPI provides an API to access Gamefin full node-related
// information.
type PublicGamefinAPI struct {
	e *Gamefin
}

// NewPublicGamefinAPI creates a new Gamefin protocol API for full nodes.
func NewPublicGamefinAPI(e *Gamefin) *PublicGamefinAPI {
	return &PublicGamefinAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicGamefinAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicGamefinAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicGamefinAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *Gamefin) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Gamefin) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Gamefin full node-related APIs
...
// admin methods of the Gamefin service.
func NewPrivateAdminAPI(eth *Gamefin) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Gamefin full node APIs exposed
...
// related public debug methods of the Gamefin service.
func NewPublicDebugAPI(eth *Gamefin) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Gamefin full node APIs exposed over
...
// private debug methods of the Gamefin service.
func NewPrivateDebugAPI(eth *Gamefin) *PrivateDebugAPI {
