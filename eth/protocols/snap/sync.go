...
import (
	...
	"github.com/gameconnection/gamefin_network/p2p/msgrate"
...
// Syncer is an Gamefin account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Gamefin state over the
// snap protocol.
