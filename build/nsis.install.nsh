...
!define HELPURL "https://github.com/gameconnection/gamefin_network/issues"
!define UPDATEURL "https://github.com/gameconnection/gamefin_network/releases"
!define ABOUTURL "https://github.com/gameconnection/gamefin_network#gamefin-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Gamefin" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Gamefin" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Gamefin" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/gamefin/EIPs/issues/147)
  ${EnvVarUpdate} $0 "GAMEFIN_SOCKET" "R" "HKLM" "\\.\pipe\geth.ipc"
  ${EnvVarUpdate} $0 "GAMEFIN_SOCKET" "A" "HKLM" "\\.\pipe\geth.ipc"
