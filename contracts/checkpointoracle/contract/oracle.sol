 ...
 * @author Gary Rong<garyrong@gamefin.org>, Martin Swende <martin.swende@gamefin.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the gamefin.
    uint sectionSize;
